  ...
  if (isComplete) {
    return (
      <motion.div
        ...
        className="flex items-center justify-center gap-2 p-4 rounded-xl bg-[var(--color-success)]/10 border border-[var(--color-success)]/20"
      >
        <CheckCircleIcon className="text-[var(--color-success)]" />
        <span className="font-medium text-[var(--color-success)]">Order Placed!</span>
      </motion.div>
    );
  }
